...
namespace UZeroConsole.Web.UZero
{
    public partial class RoleSetPermissions : AuthPageBase
    {
        ...
        int roleId = WebHelper.GetInt("roleId", 0);
        RoleDto role;
        ...
        void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                roleService.DeleteAllPermissions(role.Id);
                ...
                foreach (string pid in permissionIds)
                {
                    ...
                    roleService.AddPermission(info);
                }
        ...
        void InitPermissions()
        {
            ...
            var grantedPermissions = roleService.GetPermissions(role.Id);
            var allPermissions = permissionService.GetAll();
