<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/UZero.Master" AutoEventWireup="true" CodeBehind="AdminList.aspx.cs" Inherits="UZeroConsole.Web.UZero.Sso.AdminList" %>
    ...
    <form runat="server">
        ...
        <div class="content bg-gray-lighter">
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">Sso管理员列表<small></small>
                    </h1>
                </div>
