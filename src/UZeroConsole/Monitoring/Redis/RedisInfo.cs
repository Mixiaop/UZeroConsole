...
namespace UZeroConsole.Monitoring.Redis
{
    public partial class RedisInfo
    {
        ...
        public class ReplicationInfo : RedisInfoSection
        {
            ...
            {
                if (_slaveRegex.IsMatch(key) && value.IsNotEmpty())
                {
        ...
        public class ServerInfo : RedisInfoSection
        {
            ...
            public Version Version => _version ?? (_version = VersionNumber.IsNotNullOrEmpty() ? Version.Parse(VersionNumber) : new Version());
