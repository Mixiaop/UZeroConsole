...
namespace UZeroConsole.Monitoring.SQL
{
    public partial class SQLCluster : IEquatable<SQLCluster>, IMonitedService
    {
        ...
        public SQLNode.AGClusterState ClusterStatus =>
            Nodes.Find(n => n.AGClusterInfo.Data?.ClusterName.IsNotNullOrEmpty() ?? false)?.AGClusterInfo.Data;
        ...
        public SQLCluster(SQLSettings.Cluster cluster)
        {
            ...
            Nodes = cluster.Nodes
                           ...
                           .ToList();
            RefreshInterval = (cluster.RefreshIntervalSeconds ?? Current.MonitoringSettings.SQL.RefreshIntervalSeconds).Seconds();
        }
